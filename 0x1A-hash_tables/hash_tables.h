 ...
 * pointer of array to the first node of a linked list,
 * for our HashTable to use a Chaining collision handling
 **/
 ...
 * @array: size of an array @size
 * pointer to first node of a linked list of each array,
 * to make our HashTable use a Chaining collision handling
